...
namespace Gabrielqs\Boleto\Test\Unit\Model\Remittance\File\Order;

use \Magento\Framework\TestFramework\Unit\Helper\ObjectManager;
use Magento\Sales\Model\Order;
use \Magento\Sales\Model\OrderRepository as SalesOrderRepository;
use \Gabrielqs\Boleto\Model\Remittance\File\Order as Subject;
...
class OrderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetIdGetsTheRightKey()
    {
        $this
            ...
            ->expects($this->once())
            ->method('getData')
            ->with(Subject::REMITTANCE_FILE_ORDER_ID);
        $this->subject->getId();
    }
    ...
    public function testSetIdSetsTheRightKey()
    {
        $this
            ...
            ->expects($this->once())
            ->method('setData')
            ->with(Subject::REMITTANCE_FILE_ORDER_ID, 'foobar');
    ...
    public function testGetRemittanceFileIdGetsTheRightKey()
    {
        $this
            ->subject
            ->expects($this->once())
        ...
        $this->subject->getRemittanceFileId();
    }

    public function testSetRemittanceFileIdSetsTheRightKey()
    {
        $this
            ->subject
            ->expects($this->once())
        ...
        $this->subject->setRemittanceFileId('foobar');
    }
