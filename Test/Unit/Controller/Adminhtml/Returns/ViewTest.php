...
use \Gabrielqs\Boleto\Controller\Adminhtml\Returns\View as Subject;
...
class ViewTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->subject = $this
            ...
            ->setMethods(['_getReturnsFileIdFromRequest', '_getResultRedirect', 'initPage', '_addTitle'])
            ->getMock();
    ...
    public function testExecuteLoadsFileWithRepositoryReturnsDownloadWithRightContentsAddsIdToRegistry()
    {
        $this
            ->subject
            ->expects($this->once())
        ...
        $this
            ...
            ->expects($this->once())
            ->method('register')
            ->with(RegistryConstants::CURRENT_RETURNS_FILE_ID, 1039);
