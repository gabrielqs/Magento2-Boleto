...
namespace Gabrielqs\Boleto\Test\Unit\Model\Remittance\File\Event;

use \Magento\Framework\TestFramework\Unit\Helper\ObjectManager;
use \Gabrielqs\Boleto\Model\Remittance\File\Event as Subject;
...
class EventTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetIdGetsTheRightKey()
    {
        $this
            ...
            ->expects($this->once())
            ->method('getData')
            ->with(Subject::REMITTANCE_FILE_EVENT_ID);
        $this->subject->getId();
    }
    ...
    public function testSetIdSetsTheRightKey()
    {
        $this
            ...
            ->expects($this->once())
            ->method('setData')
            ->with(Subject::REMITTANCE_FILE_EVENT_ID, 'foobar');
